...
\item {Designed a pipeline to automatically update and self host \textbf{10M+} hotel images on \textbf{CloudFront}}
\item {Built custom ELTs to automate data extraction from multiple fintech vendors, powering the lending decisioning behind X cash advance applications}
% gha dag
% instant dag
\end{cvitems}
}

...
\cventry
{\textbf{Software Engineer} | \color{awesome}{Snapcommerce}}
{Jan - Apr 2019} % Location
{ % Description(s) of tasks/responsibilities
\begin{cvitems}
\item {Boosted Snapcommerce's Lighthouse performance score over \textbf{400\%} by making UI components SSR compatible}

...
\item {Designed a pipeline to automate the updating and self hosting of \textbf{10M+} hotel images on \textbf{CloudFront}}
\item {Built custom ELTs to automate data extraction from multiple financial data providers, powering the lending decisioning behind X cash advance applications}
% gha dag
% instant dag
\end{cvitems}
}
